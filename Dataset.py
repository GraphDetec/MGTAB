...
class MGTABlarge(InMemoryDataset):
    ...
    def process(self):
        ...
        edge_index = torch.cat([edge_index0, edge_index1, edge_index2, edge_index3, edge_index4], axis =1)
        ...
        edge_type = torch.cat([edge_type0, edge_type1, edge_type2, edge_type3, edge_type4],axis =0)
